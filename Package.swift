...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "TranscriptKit", dependencies: ["BridgeCore", "RecorderKit"],
            linkerSettings: [.linkedFramework("Speech"), .linkedFramework("Translation")]),
        .target(
            name: "AudioRealtime", publicHeadersPath: "include",
            linkerSettings: [.linkedFramework("AudioToolbox"), .linkedFramework("CoreAudio")]),
        .executableTarget(
            name: "Switchboard",
            dependencies: ["BridgeCore", "AudioRealtime", "RecorderKit", "TranscriptKit"],
            exclude: ["Resources"]),
        .executableTarget(
            name: "BridgeChecks",
            dependencies: ["BridgeCore", "AudioRealtime", "RecorderKit", "TranscriptKit"],
